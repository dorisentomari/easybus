(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.easybus = {}));
  ...
  ***************************************************************************** */
  ...
  function parseDigitalPrecision(num, precision, isCarry) {
      if (precision === void 0) { precision = 2; }
      if (isCarry === void 0) { isCarry = true; }
      num = parseToNumber(num);
      if (isCarry) {
          return parseToNumber(num.toFixed(precision));
      }
      var numStr = num.toFixed(precision + 1);
  ...
  exports.intDivFloor = intDivFloor;
  ...
  exports.parseDigitalPrecision = parseDigitalPrecision;
